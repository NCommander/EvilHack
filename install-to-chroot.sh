...
NHSUBDIR="evilhack-0.3.1-nf"
# VAR_PLAYGROUND from include/unixconf.h
NH_VAR_PLAYGROUND="/evilhack-0.3.1-nf/var/"
...
mkdir -p "$NAO_CHROOT/dgldir/inprogress-evil031nf"
chown "$USRGRP" "$NAO_CHROOT/dgldir/inprogress-evil031nf"
