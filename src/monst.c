...
NEARDATA struct permonst mons[] = {
    ...
    MON("Red Horse", S_UNICORN, LVL(18, 24, 0, 70, 0), G_NOGEN,
        ...
        M3_INFRAVISION | M3_INFRAVISIBLE, 0, 0, 21, CLR_RED),
    /*
     * vortices
     */
...
struct permonst _mons2[] = {
   ...
   MON("snark", S_JABBERWOCK,
    ...
    MON("ogre king", S_OGRE, LVL(9, 14, 4, 60, -7), (G_GENO | 2),
        ...
        M2_STRONG | M2_PRINCE | M2_MALE | M2_GREEDY | M2_JEWELS | M2_COLLECT,
        M3_ACCURATE | M3_INFRAVISIBLE | M3_INFRAVISION, 0, 0, 11, HI_LORD),
    ...
    MON("ice troll", S_TROLL, LVL(9, 10, 2, 20, -3), (G_NOHELL | G_GENO | 1),
        ...
        M1_HUMANOID | M1_REGEN | M1_CARNIVORE,
        M2_STRONG | M2_STALK | M2_HOSTILE, M3_INFRAVISIBLE | M3_INFRAVISION,
        M4_VULNERABLE_FIRE, 0, 12, CLR_WHITE),
    MON("rock troll", S_TROLL, LVL(9, 12, 0, 0, -3), (G_GENO | 1),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, 0, 0, 12, CLR_CYAN),
    MON("water troll", S_TROLL, LVL(11, 14, 4, 40, -3), (G_NOGEN | G_GENO),
        ...
        M2_STRONG | M2_STALK | M2_HOSTILE, M3_INFRAVISIBLE | M3_INFRAVISION,
        M4_VULNERABLE_ELEC, 0, 13, CLR_BLUE),
    MON("Olog-hai", S_TROLL, LVL(13, 12, -4, 0, -7), (G_GENO | 1),
        ...
        M1_HUMANOID | M1_REGEN | M1_CARNIVORE,
        M2_STRONG | M2_STALK | M2_HOSTILE | M2_COLLECT,
        M3_ACCURATE | M3_INFRAVISIBLE | M3_INFRAVISION, 0, 0, 16, HI_LORD),
    /*
     * Umber hulk
     */
     ...
     * Zombies
     */
    MON("kobold zombie", S_ZOMBIE, LVL(0, 3, 10, 0, -3),
        (G_GENO | G_LGROUP | 3),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 4), ATTK(AT_BITE, AD_DRIN, 1, 2),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(400, 50, MS_SILENT, MZ_SMALL), MR_COLD | MR_SLEEP | MR_POISON, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_POIS,
        M2_STALK | M2_HOSTILE, M3_INFRAVISION,
        M4_VULNERABLE_FIRE, MH_UNDEAD, 1, CLR_BROWN),
    MON("gnome zombie", S_ZOMBIE, LVL(1, 3, 10, 0, -3),
        (G_GENO | G_LGROUP | 3),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 5), ATTK(AT_BITE, AD_DRIN, 1, 2),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(650, 50, MS_SILENT, MZ_SMALL), MR_COLD | MR_SLEEP | MR_POISON, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_POIS,
        M2_STALK | M2_HOSTILE, M3_INFRAVISION,
        M4_VULNERABLE_FIRE, MH_GNOME | MH_UNDEAD, 2, CLR_BROWN),
    MON("orc zombie", S_ZOMBIE, LVL(2, 4, 9, 0, -3),
        (G_GENO | G_SGROUP | G_NOCORPSE | 2),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 6), ATTK(AT_BITE, AD_DRIN, 1, 2),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(850, 75, MS_SILENT, MZ_HUMAN), MR_COLD | MR_SLEEP | MR_POISON, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_POIS,
        M2_STALK | M2_HOSTILE, M3_INFRAVISION,
        M4_VULNERABLE_FIRE, MH_ORC | MH_UNDEAD, 3, CLR_GRAY),
    MON("dwarf zombie", S_ZOMBIE, LVL(2, 4, 9, 0, -3),
        (G_GENO | G_SGROUP | G_NOCORPSE | 2),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 6), ATTK(AT_BITE, AD_DRIN, 1, 2),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(900, 150, MS_SILENT, MZ_HUMAN), MR_COLD | MR_SLEEP | MR_POISON, 0,
    ...
    MON("hobbit zombie", S_ZOMBIE, LVL(2, 4, 9, 0, -3),
        (G_GENO | G_SGROUP | G_NOCORPSE | 2),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 6), ATTK(AT_BITE, AD_DRIN, 1, 2),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(850, 75, MS_SILENT, MZ_HUMAN), MR_COLD | MR_SLEEP | MR_POISON, 0,
    ...
    MON("elf zombie", S_ZOMBIE, LVL(3, 4, 9, 0, -3),
        (G_GENO | G_SGROUP | G_NOCORPSE | 2),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 7), ATTK(AT_BITE, AD_DRIN, 1, 2),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_ELF, 175, MS_SILENT, MZ_HUMAN), MR_COLD | MR_SLEEP | MR_POISON,
    ...
    MON("human zombie", S_ZOMBIE, LVL(4, 6, 8, 0, -3),
        ...
        A(ATTK(AT_CLAW, AD_PHYS, 1, 8), ATTK(AT_BITE, AD_DRIN, 1, 2),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 200, MS_SILENT, MZ_HUMAN),
        MR_COLD | MR_SLEEP | MR_POISON, 0,
    ...
    MON("ettin zombie", S_ZOMBIE, LVL(6, 6, 6, 0, -4),
        (G_GENO | G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 10), ATTK(AT_CLAW, AD_PHYS, 1, 6),
    ...
    MON("giant zombie", S_ZOMBIE, LVL(8, 6, 6, 0, -4),
        (G_GENO | G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 2, 8), ATTK(AT_CLAW, AD_PHYS, 1, 10),
